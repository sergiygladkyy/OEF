...
//Minor changes for text style by Alexander Voronin 03-Mar-2010
...
function RenderCssCal(bNewCal) {
    ...
    if (Cal.ShowTime) {
        ...
        if (ShowArrows && UseImageFiles) {
            vCalTime+="<td align='center'><table border='0' cellspacing='0' cellpadding='0' style='line-height:0pt'><tr><td><img onmousedown='startSpin(\"Hour\", \"plus\");' onmouseup='stopSpin();' src='"+ImageRoot+"images/cal_plus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr><tr><td><img onmousedown='startSpin(\"Hour\", \"minus\");' onmouseup='stopSpin();' src='"+ImageRoot+"images/cal_minus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr></table></td>\n";
        }

        vCalTime+="<td align='center' width='22px'><input type='text' name='hour' maxlength='2' size='1' style='WIDTH:22px' value='"+showHour+"' onChange='javascript:Cal.SetHour(this.value)'></td>";
        vCalTime+="<td align='center' width='5px' style='font-size:100%; font-weight:bold;'>:</td>";
        vCalTime+="<td align='center' width='22px'><input type='text' name='minute' maxlength='2' size='1' style='WIDTH: 22px' value='"+Cal.Minutes+"' onChange='javascript:Cal.SetMinute(this.value)'>";
    ...
    funcCalback+=" var tzo=(dtToday.getTimezoneOffset()/60)*(-1);\n";
    funcCalback+="dtToday.setHours(dtToday.getHours()-tzo);\n";
    funcCalback+=" var timeZoneString='';\n";
    funcCalback+=" if(tzo>0)\n";
    funcCalback+="timeZoneString='+'+tzo;\n";
    funcCalback+="else if(tzo<0)\n";
    funcCalback+="timeZoneString='-'+tzo;\n";
