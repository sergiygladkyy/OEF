...
<nobr>
  ...
  <img onclick="{{ 'NewCssCal(\''..id..'\',\'yyyymmdd\',\'arrow\',true, 24, false)' }}" alt="Pick a date" src="/ext/OEF/Framework/MindTouch/Js/datetimepicker/images/cal.gif" style="vertical-align: top; padding-top: 1px;" />
</nobr>
