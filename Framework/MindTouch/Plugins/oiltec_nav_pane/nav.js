...
Deki.nav = function()
{
	...
	return {
		...
		animComplete: function()
		{
			...
			if(redirect && ((Deki.$(selectedNode).attr("reload") == "1") || !(disableNavWhenEditorIsLoaded && Deki.Editor && Deki.Editor.IsStarted)))
			{
		...
		redirect: function()
		{
			...
			if ( YAHOO.env.ua.opera && Deki.Editor && Deki.Editor.Cancel && !Deki.Editor.Cancel() )
			{
				return false;
			}
