...
<div class="userTabs">
  <div id="htab1">
    <a href="#"  class="active"  onclick="show('tab1'); return false;" ><b>Personal info</b></a>
    <a href="#" onclick="show('tab2'); return false;"><b>Organization</b></a>
  </div>
  <div id="htab2" style="display:none;">
    <a href="#" onclick="show('tab1'); return false;" ><b>Personal info</b></a>
    <a href="#" class="active" onclick="show('tab2'); return false;" ><b>Organization</b></a>
  </div>
</div>
