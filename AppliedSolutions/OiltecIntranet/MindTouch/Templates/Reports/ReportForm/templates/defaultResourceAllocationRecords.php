      ...
      <tr>
        ...
        <td class="{{ class..'_value ae_editform_field_value' }}">
          ...
          <eval:if test="field == 'Period'">
            <img src="/skins/common/icons/silk/help.png" style="position: relative; left: 13px; top: 2px;" title="You can use periods: “Last Week”, “This Week”, “Next Week”, “Last Month”, “This Month”, “Next Month”, “Last Quarter”, “This Quarter”, “Next Quarter”, “Last Year”, “This Year”, “Next Year”">
          </eval:if>
        </td>
      </tr>
    </eval:foreach>
