...
<html>
  <head>
    ...
    <script type="text/javascript">
      "jQuery(document).ready(function() { jQuery('#"..zone.."').html('<div class=\"oef_content\"><h3 style=\"clear:both\">WorkingOnMyProjects</h3><div id=\"oef_working_on_my_projects\">&nbsp;</div></div>'); });"
    </script>
  </head>
  <body></body>
  <tail>
