...
<form action="#" method="post" class="oe_custom_edit_form" id="<?php echo $kind.'_'.$type.'_item' ?>">
  ...
  <input type="submit" value="<?php echo $isNew ? 'Save' : 'Update' ?>" />
</form>
<br />
<script type="text/javascript">
<?php if ($isNew): ?>
  displayMessage('<?php echo $kind.'_'.$type ?>', 'Calendar for this year not exists. This calendar was generated by default.', 2);
<?php endif; ?>
